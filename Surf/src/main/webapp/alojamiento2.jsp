<%-- 
    Document   : alojamiento2
    Created on : 28-ene-2024, 19:43:01
    Author     : CAROL
--%>
    ...
    <body>
        ...
        <section class="video-bg va6-position-relative">
            <div class="video-bg__media" aria-hidden="true">
                ...
                <video autoplay loop muted playsInline src="video/videoAsturias.mp4"></video>
            </div>
            ...
            <div class="va6-container va6-max-width-lg va6-position-relative va6-z-index-2">
                <div class="va6-flex va6-flex-center va6-padding-y-3xl">
                    <div class="va6-text-component va6-text-center">
                        <h1 style="color: #fff; font-size: 85px;">ASTURIAS</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <br>
        <!-- ########################################## ALOJAMINETOS ASTURIAS ######################################################## -->

        <% for (int i = 4; i < Math.min(8, alojamiento.size()); i++) {%>
            ...
            <div class="col-md-5 mx-auto flechacontraria ">
                <ul class="wrapper">
                    <li class="icon black">
                        ...
                        <span><a href="alojamiento.jsp"></a><svg viewBox="0 0 16 16" class="bi bi-chevron-double-left"
                    ...
                    <li class="icon black">
                        ...
                        <span><a href="alojamiento3.jsp"><svg viewBox="0 0 16 16" class="bi bi-chevron-double-right"
                                                              fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                                <path
