    ...
    <body>
        ...
        <section class="video-bg va6-position-relative">
            <div class="video-bg__media" aria-hidden="true">
                ...
                <video autoplay loop muted playsInline src="video/videoGalicia.mp4"></video>
            </div>
            ...
            <div class="va6-container va6-max-width-lg va6-position-relative va6-z-index-2">
                <div class="va6-flex va6-flex-center va6-padding-y-3xl">
                    <div class="va6-text-component va6-text-center">
                        <h1 style="color: #fff; font-size: 85px;">GALICIA</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <br>
        <!-- ########################################## ALOJAMINETOS GALICIA ######################################################## -->

        <% for (int i = 0; i < Math.min(4, alojamiento.size()); i++) {%>
            ...
            <div class="col-md-5 mx-auto flechacontraria ">
                <ul class="wrapper">
                    ...
                    <li class="icon black">
                        ...
                        <span><a href="alojamiento2.jsp"><svg viewBox="0 0 16 16" class="bi bi-chevron-double-right"
