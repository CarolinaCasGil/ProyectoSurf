...
<html>
    ...
    <body>
        ...
        <div class="row mx-auto col-md-11">
            <div class=" mb-4">
                <a href="apackin.jsp" style="text-decoration: none;">
            ...
            <table class="mx-auto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<%= p.getFoto()%>" alt="alt" style="width: 80%;"/></td>
                        <td><%= p.getCantComprada()%></td>
                        <td><%= p.getIdActividad()%></td>
                        <td>
                            <div class="buttons-container">
                                <a href="apackmo.jsp?id=<%= p.getIdPack()%>" class="btn-modificar" style="text-decoration: none; color: white;">Modificar</a>
                                <form action="/Surf/APack" method="post">
                                    <input type="hidden" name="id" value="<%= p.getIdPack()%>">
