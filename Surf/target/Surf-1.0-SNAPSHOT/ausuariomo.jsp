            ...
            <div class="mb-4">
                <div class="card transparent-card">
                    <div class="card-body center-content">
                        <h1>Modificar el usuario con ID <%= idUsuario%></h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 col">
                                        ...
                                        <input type="text" class="form-control" id="nom_usuario" name="nom_usuario"
                                               value="<%= usuarioModificar.getNomUsuario()%>">
                                    </div>
                                    <div class="mb-3 col">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="email" name="email"
                                               value="<%= usuarioModificar.getEmail()%>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col">
                                ...
                                <div class="row">
                                    <div class="mb-3 col">
                                        ...
                                        <input type="text" class="form-control" id="apellido" name="apellido"
                                               value="<%= usuarioModificar.getApellido()%>">
                                    </div>
                                    <div class="mb-3 col">
                                        <label for="clave" class="form-label">Contraseña</label>
                                        <input type="text" class="form-control" id="clave" name="clave"
                                               value="<%= usuarioModificar.getClave()%>">
                                    </div>
                                </div>
