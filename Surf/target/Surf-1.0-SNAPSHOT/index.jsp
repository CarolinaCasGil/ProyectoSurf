            ...
            <div class="col-sm-6 col-md-6 p-4 ml-5 mx-auto my-auto">
                <div class="card" style="width: 100%; background-color: rgba(255, 255, 255, 0.767);">
                    <div class="card-body">
                        ...
                        <p class="card-text">En nuestro surfcamp, te sumergirás en una experiencia única que combina la
                            emoción del surf con la serenidad de la naturaleza. En Blue Waves, no solo ofrecemos lecciones
                            de surf de alta calidad para todos los niveles, sino que también creamos un ambiente relajado y
                            amigable donde los amantes del surf, tanto novatos como experimentados, pueden conectarse y
                            compartir su pasión por las olas.</p>
                    </div>
                </div>
            </div>
